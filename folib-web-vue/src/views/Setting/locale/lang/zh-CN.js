export default {
    ...
    'TransferSliceSize': '制品传输切片大小，大制品节点之间传输切片大小（上限2000MB=2048000KB）',
    'NodeSpeedLimit': '节点传输节点传输限速（KB/s），不设置则不限速。传输节点限速未设置，则采用全局限速；全局和传输节点均未设置，则传输不限速（上限2000MB=2048000KB）',
    'useBaseUrl': 'baseurl，如果你使用了反向代理公网等情况下可以使用它',
    'communicationPort': 'Server服务的后端通信端口',
    'username': '用户名',
    'Password': '密码',
    'Port': '端口',
    'ProtocolType': '协议类型',
    ...
    'SaveOperation': '保存操作',
    'saveButton': '该保存按钮将会针对以上4个部分的修改统一保存',
    'Cancel1': '取 消',
    'Save1': '保 存',
    'Save': '保存',
    'SecurityPolicy': '安全策略',
    ...
    'ProductAbsolutePath': '制品绝对路径',
    'specifyDirectoryBuildData': '可指定目录进行构建数据，若不填写则为仓库的根目录',
    'DirectoryAbsolutePath': '目录为绝对路径（容器部署，则为容器内部的绝对路径）',
    'enterAbsoluteProductPath': '请输入制品绝对路径',
    ...
    'sureUpdateTheVulnerabilityData': '确定要更新漏洞数据吗?',
    'Update': '更新',
    'BackupStrategy': '备份策略',
