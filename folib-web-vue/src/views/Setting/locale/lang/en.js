export default {
    ...
    'Enterprise': 'Click to view Enterprise Edition ',
    ...
    'Disclaimer1': 'The folib Repository Open Source Version (hereinafter referred to as the "Open Source Version") is a free and open-source software provided by folib Repository, aiming to offer developers a convenient artifact management tool. Before using the Open Source Version, users are required to carefully read and fully understand all the contents of this disclaimer.',
    'Disclaimer2': 'By installing this software, you are deemed to have clearly acknowledged and agreed to all the terms of this disclaimer; if you do not accept this disclaimer, please do not install it or uninstall it immediately.',
    'DisclaimerTitle1': '1. Software Use and Liability Definition',
    'Disclaimer3': 'The Open Source Version is provided "as is". folib Repository makes no express or implied warranties regarding the applicability, reliability, security, accuracy, and completeness of the Open Source Version, including but not limited to warranties for fitness for a particular purpose, freedom from defects, and uninterrupted operation.',
    'Disclaimer4': 'Under no circumstances shall folib Repository be liable for any direct, indirect, incidental, special, punitive, or consequential damages (including but not limited to data loss, business interruption, loss of profits, etc.) arising from the use or inability to use the Open Source Version, even if it has been informed of the possibility of such damages.',
    'DisclaimerTitle2': '2. Special Notes on User Information and Data',
    'Disclaimer5': 'In the Open Source Version, all user information and data (including but not limited to artifact files, configuration information, operation records, account information, etc.) shall be managed and taken responsibility for by the users themselves.',
    'Disclaimer6': 'folib Repository',
    'Disclaimer7': 'provides no commercial guarantees for the security, integrity, and confidentiality of user information and data,',
    'Disclaimer8': 'and shall not be liable for any direct or indirect damages resulting from data loss, leakage, tampering, or unauthorized access, etc.',
    'Disclaimer9': 'The design of the Open Source Version does not include commercial guarantee mechanisms such as enterprise-level data encryption, disaster recovery backup, and compliance auditing, and the relevant risks shall be borne by the users.',
    'DisclaimerTitle3': '3. Scope of Services and Support',
    'Disclaimer10': 'The open-source license terms of the Open Source Version only grant users the right to use, copy, modify, and distribute the software within the scope specified in the license agreement, and do not include commitments to commercial services such as technical support, maintenance services, and upgrade services.',
    'DisclaimerTitle4': '4. Recommendation of Enterprise-level Solutions',
    'Disclaimer11': 'If you need more stable operation guarantees,',
    'Disclaimer12': 'professional information and data security protection',
    'Disclaimer13': ', enterprise-level technical support, and customized services, you are welcome to upgrade to the folib Repository Enterprise Version. For details, please visit the official website',
    'Disclaimer14': 'folib Repository reserves the right to modify this disclaimer at any time. The revised content will be updated on the relevant pages of the Open Source Version, and your continued use shall be deemed as acceptance of the updated terms. It is recommended that you check it regularly to learn about the latest content.'
}
