export default {
    ...
    'TransferSliceSize': 'Slice size for artifact transfer, slice size for large artifact transfer between nodes (upper limit 2000MB=2048000KB)',
    'NodeSpeedLimit': 'Node Transmission Rate limiting node transmission (KB/s). If this parameter is not set, the rate is not limited. If the transmission node rate limit is not set, the global rate limit is adopted. If both global and transfer nodes are not configured, the transmission rate is not limited (Upper limit 2000MB= 2,048,000 KB)',
    'useBaseUrl': 'baseurl, you can use it if you use a reverse proxy on the public web and so on',
    'communicationPort': 'Server server backend communication port',
    'username': 'username',
    'Password': 'Password',
    'Port': 'Port',
    ...
    'saveButton': 'The save button will save all the changes in the above four sections.',
    'Cancel1': 'Cancel',
    'Save1': 'Save',
    'Save': 'Save',
    ...
    'ProductAbsolutePath': 'Product absolute path',
    ...
    'DirectoryAbsolutePath': 'Directory is an absolute path (or, in the case of a container deployment, an absolute path inside the container)',
    'enterAbsoluteProductPath': 'Please enter absolute product path',
    ...
    'sureUpdateTheVulnerabilityData': 'Are you sure you want to update the vulnerability data?',
    'Update': 'Update',
    'BackupStrategy': 'Backup strategy',
    'setTheBackupPolicy': 'This function is used to set the backup policy to backup the product data of the specified storage space and warehouse',
