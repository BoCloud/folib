        ...
        <a-row :gutter="24" type="flex" align="stretch">
          <a-col :span="24" :lg="8" class="mb-24">
            <a-card :bordered="false" class="header-solid" :bodyStyle="{padding: '0 12px 8px 3px'}">
              ...
              <ChartLineGradient ref="cpu" :labels="cpuLabels"
                                 :dataOne="cpuDataOne"
                                 :dataTwo="cpuDataTwo"
                                 dataOneTag="系统CPU"
          ...
          <a-col :span="24" :lg="8" class="mb-24">
            <a-card :bordered="false" class="header-solid" :bodyStyle="{padding: '0 12px 8px 3px'}">
              ...
              <ChartLineGradient ref="mem" :labels="memLabels"
                                 :dataOne="memDataOne"
                                 :dataTwo="memDataTwo"
                                 dataOneTag="最大可用内存"
          ...
          <a-col :span="24" :lg="8" class="mb-24">
            <a-card :bordered="false" class="header-solid" :bodyStyle="{padding: '0 12px 8px 3px'}">
              ...
              <ChartLineGradient ref="thread" :labels="threadLabels"
        ...
        <a-row type="flex" :gutter="[24,24]">
          <a-col :span="24" :lg="6">
            <a-affix :offset-top=" navbarFixed ? 100 : 10 ">
              <a-card :bordered="false" class="header-solid mb-24" id="result" :bodyStyle="{ height: '600px', display: 'flex', alignItems: 'center', justifyContent: 'center'}">
                <template #title>
...
import {getMetrics,getMetricsHealth,viewLogs,gremlinQuery,gremlinVertex,gremlinEdge} from "@/api/monitor";
// Importing charts
