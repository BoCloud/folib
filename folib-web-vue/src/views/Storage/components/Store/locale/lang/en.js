export default {
    ...
    'CondaGlobalConfiguration': 'To point the Conda client to the FoLib repository, edit the configuration file under your user directory (for example ~/.condarc):',
    'CondaDeploy': 'Publish',
    'CondaDeployConfig': 'To publish a package and upload it to FoLib, use the curl command.',
    'CondaInstall': 'Install',
    'CondaInstallConfig': 'To install a package, use the conda install command.',
    //cjpm
    'CjpmInstallCommand': 'Install cjpmp command',
    'CjpmInstallCommandDetail': 'CJPM currently does not support importing dependencies from the Folib. You will need to download additional command tools.',
    'CjpmConfiguration': 'Global configuration',
    'CjpmConfigurationDetail': 'Set the Folib address and access token through environment variables',
    'CjpmPublish': 'Publish Cangjie Package',
    'CjpmPublishDetail': 'Use "cjpmp publish" to publish a package and upload it to Folib.',
    'CjpmImport': 'Import Dependency',
    'CjpmImportDetail': 'To use the Cangjie package in the product library, the following configuration needs to be made in the cjpm.toml file, and the project should be compiled using the "cjpmp build" command.',
    'Recursive': 'Recursive',
