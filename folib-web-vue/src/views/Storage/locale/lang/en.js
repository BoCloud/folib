export default {
    ...
    'CustomLayoutEmpty':'Please select a custom layout',
    'RemoteRepositoryUrlEmpty':'Please fill in the remote access address',
    'Strategy': 'Strategy',
    'Local': 'Local',
    'Agent': 'Agent',
    ...
    'ItemLimit': 'Item Upload Size Limit (MB)',
    'ItemLimitPlaceholder': 'Default 102400MB',
    'RepositorySizeLimit': 'Repository Size Limit (GB)',
    'RepositorySizeLimitPlaceholder': 'Default 0GB, 0GB means no limit',
    ...
    'DockerAddressFormat': 'Example: https://registry-1.docker.io/v2',
    'Test': 'Test',
    'Username': 'Username',
    ...
    'PasswordTokenPlaceholder': 'Please enter Password or Access Token',
    'Password': 'Password',
    ...
    'RepositoryLengthLimit': 'Repository names are between 1 and 50 characters long',
    'RepositoryLimit': 'Repository names should be uppercase or lowercase letters, numbers, special symbols (-_.) , cannot begin with _.',
    'DockerRepositoryLimit': 'Repository names should be lowercase letters, numbers, special symbols (-_.) , cannot begin with _.',
    ...
    'DeletedVulnerabilityPackage': 'Deleted vulnerability package',
    'ScanForDeletedDependencies': 'Scan for deleted dependencies',
    'DeletedVulnerabilityDependency': 'Deleted vulnerability dependency',
    'DeletedSealedVulnerabilitiesNum': 'Number of deleted sealed vulnerabilities',
    ...
    // 'rust':'rust',
    // 'php':'php',
    'cjpm':'Cangjie is a next-generation programming language designed for all-scenario intelligence. It features native intelligence, innate multi-scenario support, high performance, and strong security, offering developers an exceptional programming experience. The Cangjie Package Manager (cjpm) provides component version management, supports proxying the central Cangjie repository, and can be used for localized management of secondary dependencies.。',
    'modelscope':'ModelScope is an AI model community repository developed by Damo Academy, offering developers a one-stop solution for AI model management. It supports proxy downloads of ModelScope AI models, significantly boosting development efficiency. The platform also provides a powerful command-line tool that enables private hosting of models. Whether it’s uploading, downloading, or deploying models, all operations can be easily performed using this tool, providing a solid foundation for enterprises to build their own dedicated AI model environments.',
