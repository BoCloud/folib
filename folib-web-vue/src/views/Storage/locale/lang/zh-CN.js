export default {
    ...
    'AllStorageSpace': '全部存储空间',
    'ChangeStorageSpace': '切换存储空间',
    ...
    'CustomLayoutEmpty':'请选择自定义布局',
    'RemoteRepositoryUrlEmpty':'请填写远程访问地址',
    'Strategy': '策略',
    'Local': '本地',
    'Agent': '代理',
    'Combination': '组合',
    ...
    'ItemLimit': '制品上传大小限制(MB)',
    'ItemLimitPlaceholder': '默认102400MB',
    'RepositorySizeLimit': '仓库存储限制(GB)',
    'RepositorySizeLimitPlaceholder': '默认0GB,0GB表示不限制',
    ...
    'DockerAddressFormat': '例如：https://registry-1.docker.io/v2',
    'Test': '测试',
    'Username': '用户名',
    ...
    'PasswordToken': '密码/Access Token',
    'PasswordTokenPlaceholder': '请输入密码或Access Token',
    'Password': '密码',
    ...
    'RepositoryLengthLimit': '仓库名称长度在 1 到 50 个字符',
    ...
    'DeletedVulnerabilityPackage': '漏洞包减少',
    'ScanForDeletedDependencies': '扫描依赖减少',
    'DeletedVulnerabilityDependency': '漏洞依赖减少',
    'DeletedSealedVulnerabilitiesNum': '封存漏洞数减少',
    '30daysData': '近30天数据',
    ...
    'cjpm':'仓颉(Cangjie)编程语言是一款面向全场景智能的新一代编程语言，主打原生智能化、天生全场景、高性能、强安全，为开发者提供良好的编程体验。为仓颉编译工具cjpm提供组件包版本管理，可代理仓颉中心仓库，用于本地化二方依赖管理等。',
    'modelscope':'ModelScope 是达摩院开发的AI模型社区仓库，为开发者提供一站式的 AI 模型管理体验。其支持 ModelScope AI 模型代理下载，极大提升开发效率。同时，平台配套的 ModelScope 命令行工具功能强大，可用于私有化托管，无论是模型的上传、下载，还是部署等操作，均可借助该工具便捷实现，为企业构建专属的 AI 模型环境提供坚实支撑 。',
