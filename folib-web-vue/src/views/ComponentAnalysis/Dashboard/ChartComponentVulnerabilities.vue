<template>
  <div>
    <a-card :bordered="false">
      <h6 class="font-regular text-md mb-0" :class="'mb-10'">{{ "组件" }}</h6>
      <div class="echart">
  ...
  methods: {
    getDaysData() {
      ...
      for (let i = 0; i < this.dayData.length; i++) {
        ...
        this.totalData.push(this.dayData[i].components);
        this.affectedData.push(this.dayData[i].vulnerableComponents);
