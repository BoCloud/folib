<template>
  <div>
    <a-card :bordered="false">
      <h6 class="font-regular text-md mb-0" :class="'mb-10'">{{ "违反政策" }}</h6>
      <div class="echart">
  ...
  methods: {
    getDaysData() {
      ...
      for (let i = 0; i < this.dayData.length; i++) {
        ...
        this.failData.push(this.dayData[i].policyViolationsFail);
        this.warnData.push(this.dayData[i].policyViolationsWarn);
        this.infoData.push(this.dayData[i].policyViolationsInfo);
