<template>
  <div>
    <a-card :bordered="false">
      <h6 class="font-regular text-md mb-0" :class="'mb-10'">{{ "审核进度" }}</h6>
      <div class="echart">
  ...
  methods: {
    getDaysData() {
      ...
      for (let i = 0; i < this.dayData.length; i++) {
        ...
        this.totalData.push(this.dayData[i].findingsTotal);
        this.auditedData.push(this.dayData[i].findingsAudited);
