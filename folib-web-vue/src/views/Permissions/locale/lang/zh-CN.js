export default {
    ...
    'GroupsDesc': '选择组及其对所选资源的操作',
    'EnterTheNameCreate': '输入唯一名称',
    ...
    'SelectedGroups': '选择组',
    'SelectGroups': '选择组',
    'GroupNoPermissionsTip': '未选择任何权限。此组不会保存在权限目标中。',
    'SelectedGroupRepositories': '选定的组仓库',
    'SelectedGroupBuilds': '选定的组构建',
    'SelectedGroupBundles': '选定组发布包',
}
