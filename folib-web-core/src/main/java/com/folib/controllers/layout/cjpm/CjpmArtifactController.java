 ...
 */
package com.folib.controllers.layout.cjpm;
 ...
 */
@RestController
@LayoutReqMapping(CjpmLayoutProvider.ALIAS)
@Api(description = "cjpm坐标控制器",tags = "cjpm坐标控制器")
public class CjpmArtifactController
