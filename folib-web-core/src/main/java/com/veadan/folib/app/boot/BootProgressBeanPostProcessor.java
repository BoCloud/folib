//package com.veadan.folib.app.boot;
//
//import com.veadan.folib.config.SwaggerConfig;
//import com.veadan.folib.config.WebSecurityConfig;
...
//            { HazelcastConfiguration.class.getName(), "Waiting for cache..." },
...
//            { SwaggerConfig.class.getName(), "Loading documentation..." },
...
//        {
//                // 创建JettyServletWebServerFactory对象，用于配置Jetty服务器
//                JettyServletWebServerFactory factory = new JettyServletWebServerFactory();
//
//                // 添加服务器定制器，用于在服务器启动前修改服务器配置
//                factory.addServerCustomizers(server -> {
//                            // 遍历服务器的所有连接器
//                            for (Connector conn : server.getConnectors()) {
//                                // 检查连接器是否为ServerConnector类型，以安全地进行类型转换
//                                if (conn instanceof ServerConnector sc) {
//                                    // 设置连接器的重用地址属性为true，允许在服务器重启时重用上一个地址
//                                    sc.setReuseAddress(true);
//                                }
//                            }
//                        });
//               // bean = factory;
//            startWebServer(factory);
//        }
//
//        return bean;
//    }
