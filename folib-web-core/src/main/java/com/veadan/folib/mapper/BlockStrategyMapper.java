...
public interface BlockStrategyMapper extends BaseMapper<BlockStrategy> {
     ...
     * @return 阻断策略列表
     */
    List<BlockStrategy> selectBlockList(@Param("blockStrategy") BlockStrategyDto blockStrategyForm);
     ...
     * @return 阻断策略列表
     */
    List<BlockStrategyRecord> selectInfoList(@Param("blockStrategy") BlockStrategyDto blockStrategyForm);
}
