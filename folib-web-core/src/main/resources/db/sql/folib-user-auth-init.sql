...
CREATE TABLE `folib_user` (
                              ...
                              `enabled` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '0' COMMENT '是否启用',
...
CREATE TABLE `role_resource_ref` (
                                     ...
                                     `storage_provilege` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '存储空间权限',
