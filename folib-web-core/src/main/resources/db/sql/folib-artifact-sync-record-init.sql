...
(
    ...
    `source_path`   longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci COMMENT '源制品路径',
    `target_path`   longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci COMMENT '目标制品路径',
    `sync_no`       varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '制品同步编号',
  ...
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='制品同步记录'
