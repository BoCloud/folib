...
public class RepositoryDto {
    ...
    @Valid
    private ProxyConfigurationDto proxyConfiguration;
     ...
     * 白名单列表
     */
    @NotEmpty(message = "请填写白名单", groups = {RepositoryDto.WhiteGroup.class})
    private Set<String> vulnerabilityWhites;
    /**
     * 黑名单列表
     */
    @NotEmpty(message = "请填写黑名单", groups = {RepositoryDto.BlackGroup.class})
    ...
    public ProxyConfigurationDto getProxyConfiguration() {
        return proxyConfiguration;
    }

    public void setProxyConfiguration(final ProxyConfigurationDto proxyConfiguration) {
    ...
    public void setRemoteRepository(final RemoteRepositoryDto remoteRepository) {
    ...
    public void setRepositoryConfiguration(final CustomRepositoryConfigurationDto repositoryConfiguration) {
