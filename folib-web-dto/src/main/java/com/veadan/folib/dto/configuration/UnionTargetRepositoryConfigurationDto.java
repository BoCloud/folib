...
@AllArgsConstructor
@NoArgsConstructor
public class UnionTargetRepositoryConfigurationDto
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UnionTargetRepositoryConfigurationDto)) {
            return false;
        }
        UnionTargetRepositoryConfigurationDto that = (UnionTargetRepositoryConfigurationDto) o;
