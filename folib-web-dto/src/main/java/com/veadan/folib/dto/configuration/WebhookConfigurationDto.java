...
public class WebhookConfigurationDto
    ...
    public WebhookConfigurationDto(WebhookConfiguration webhookConfiguration) {
    ...
    @JsonIgnore()
    public static WebhookConfigurationDto fromConfiguration(WebhookConfiguration source) {
        ...
        return new WebhookConfigurationDto(webhookConfiguration);
    }
