...
public class SmtpConfigurationDto {
    ...
    public SmtpConfigurationDto(String host,
                                Integer port,
                                String connection,
                                String username,
                                String password) {
    ...
    @JsonIgnore()
    public static SmtpConfigurationDto fromConfiguration(SmtpConfiguration source) {
        SmtpConfiguration configuration = Optional.ofNullable(source).orElse(
                new SmtpConfiguration(new MutableSmtpConfiguration())
        );

        return new SmtpConfigurationDto(configuration.getHost(),
