...
import com.veadan.folib.cron.jobs.FetchRemoteRpmChangesFeedCronJob;
...
public class RpmRepositoryManagementStrategy extends AbstractRepositoryManagementStrategy{
    ...
    private static final Logger logger = LoggerFactory.getLogger(RpmRepositoryManagementStrategy.class);
            ...
            throws RepositoryManagementStrategyException
    {
        ...
        configuration.setName(FetchRemoteRpmChangesFeedCronJob.calculateJobName(storageId, repositoryId));
        configuration.setJobClass(FetchRemoteRpmChangesFeedCronJob.class.getName());
