...
// */
//@Component
//public class PubSearchResultSupplier implements Function<Path, SearchResult>
//{
//
//    private static final Logger logger = LoggerFactory.getLogger(PubSearchResultSupplier.class);
//
