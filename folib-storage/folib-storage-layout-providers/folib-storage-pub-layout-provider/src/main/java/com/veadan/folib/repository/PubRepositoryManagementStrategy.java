...
//import com.veadan.folib.cron.jobs.FetchRemotePubChangesFeedCronJob;

@Component
public class PubRepositoryManagementStrategy
        extends AbstractRepositoryManagementStrategy {

    private static final Logger logger = LoggerFactory.getLogger(PubRepositoryManagementStrategy.class);
...
//        configuration.setName(FetchRemotePubChangesFeedCronJob.calculateJobName(storageId, repositoryId));
//        configuration.setJobClass(FetchRemotePubChangesFeedCronJob.class.getName());
