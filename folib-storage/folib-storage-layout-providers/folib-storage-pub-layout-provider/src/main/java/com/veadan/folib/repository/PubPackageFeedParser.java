...
//
//        PubArtifactCoordinates c = PubArtifactCoordinates.of(packageVersion.getName(), packageVersion.getVersion(),packageSuffix);
...
//        String packageId = PubArtifactCoordinates.calculatePackageId("unscoped".equals(scope) ? null : scope,
//                packageEntry.getName());
//
//        PubArtifactCoordinates c = PubArtifactCoordinates.of(packageId, packageEntry.getVersion(),packageSuffix);
//
