...
public class PubUtils {
    ...
    public static String getPackageMetadataPath(String packageName) {
        return String.join("/", ".pub", packageName);
    }

    public static String getPackageMetadataFilePath(String packageName) {
        return String.join(".", getPackageMetadataPath(packageName), "json");
    }
    ...
    public static boolean isNameFieldValid(String value) {
        return (StringUtils.isNotBlank(value) && value.equals(value.toLowerCase()) &&
                isNameMatchConvention(value));
    }
